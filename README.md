...
- Inserisci qui il tipo di licenza (es. MIT) e i riferimenti eventuali.  
- Dati di `μ` planetari da fonti pubbliche (valori standard comunemente usati).
...
**Autore**: Progetto didattico personalizzato per studi **CubeSat**.
